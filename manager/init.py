...
def run(arg):
    logging.info('Init')
    os.system('sudo apt-get install -y libopencv-dev libudev-dev libsfml-dev libconsole-bridge-dev libx11-dev \
    libxrandr-dev libfreetype6-dev libboost1.58-all-dev libncurses5-dev')
